<template>
     ...
     <a :href="href" :download="download" class="btn btn-sm btn-icon btn-success btn-round pull-right" style="border:thin line black; color:#fff;"><i class="fa-file-excel-o"> </i>  </a>
