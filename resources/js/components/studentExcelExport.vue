<template>
     ...
     <a :href="href" :download="download" class="btn btn-sm btn-icon btn-success btn-round pull-right" style="border:thin line black; background:#396; color:#fff;"><i class="fa fa-file-excel-o"> </i>  </a>
