            ...
            <div class="card card-shadow text-center">
              <div class="card-block">
                <a class="avatar avatar-lg" href="javascript:void(0)">
                 <img v-bind:src="'./assets/images/uploads/mNfCc10LsxAHGu4l.png'"  alt="...">
                </a>
                    ...
                    <ul class="list-group">
                        ...
                        <div class="media">
                          <div class="pr-20">
                            <a class="avatar" href="javascript:void(0)">
                              <img class="img-fluid" v-bind:src="'./assets/global/portraits/2.jpg'"
                                alt="...">
                            </a>
                          </div>
                      ...
                      <li class="list-group-item">
                        <div class="media">
                          <div class="pr-20">
                            <a class="avatar" href="javascript:void(0)">
                              <img class="img-fluid" v-bind:src="'./assets/global/portraits/3.jpg'"
                                alt="...">
                            </a>
                          </div>
                          <div class="media-body">
                            ...
                            <div class="profile-brief clearfix">
                              <img class="profile-uploaded" v-bind:src="'./assets/global/photos/placeholder.png'" alt="...">
                              <img class="profile-uploaded" v-bind:src="'./assets/global/photos/placeholder.png'" alt="...">
                              <img class="profile-uploaded" v-bind:src="'./assets/global/photos/placeholder.png'" alt="...">
                              <img class="profile-uploaded" v-bind:src="'./assets/global/photos/placeholder.png'" alt="...">
                            </div>
                      ...
                      <li class="list-group-item">
                        <div class="media">
                          <div class="pr-20">
                            <a class="avatar" href="javascript:void(0)">
                              <img class="img-fluid" v-bind:src="'./assets/global/portraits/4.jpg'"
                                alt="...">
                            </a>
                          </div>
                          <div class="media-body">
                      ...
                      <li class="list-group-item">
                        <div class="media">
                          <div class="pr-20">
                            <a class="avatar" href="javascript:void(0)">
                              <img class="img-fluid" v-bind:src="'./assets/global/portraits/5.jpg'"
                                alt="...">
                            </a>
                          </div>
                          <div class="media-body">
                            ...
                            <div class="profile-brief">
                              <div class="media">
                                <a class="pr-20">
                                  <img class="w-160" v-bind:src="'./assets/global/photos/placeholder.png'" alt="...">
                                </a>
...
<script>
    ...
    export default
    {
        ...
        methods:{
            ...
            fetchStudentProfile(page_url)
            {
                let vm = this;
                page_url = page_url || '/api/student-profile/' + this.$route.params.id;
                fetch(page_url)
                .then(res => res.json())
                .then(res => {
