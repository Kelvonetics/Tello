      ...
      <ul class="site-menu">
        ...
        <li class="site-menu-item has-sub">
          <a href="javascript:void(0)">
              ...
              <span class="site-menu-title"> <router-link class="block" to="/sessions" style="color: rgba(158,158,158,.9)"> Academic Session </router-link> </span> 
              {{-- <span class="site-menu-arrow"></span> --}}
          </a>
        </li>
        ...
        <li class="site-menu-item has-sub">
          ...
          <ul class="site-menu-sub">
            <li class="site-menu-item">
              <a class="" href="#">
                <span class="site-menu-title"> <router-link class="block" to="/students" style="color: rgba(158,158,158,.9)"> Students </router-link> </span>
              </a>
            </li>
            <li class="site-menu-item">
              <a class="" href="#">
                <span class="site-menu-title"> <router-link class="block" to="/staff" style="color: rgba(158,158,158,.9)"> Staff </router-link> </span>
              </a>
            </li>
          </ul>
        </li>
        ...
        <li class="site-menu-item has-sub">
          <a href="javascript:void(0)">
              ...
              <span class="site-menu-title"> <router-link class="block" to="/class" style="color: rgba(158,158,158,.9)"> Classes </router-link> </span> 
              {{-- <span class="site-menu-arrow"></span> --}}
          </a>
        </li>
        ...
        <li class="site-menu-item has-sub">
          <a href="javascript:void(0)">
              ...
              <span class="site-menu-title"> <router-link class="block" to="/subjects" style="color: rgba(158,158,158,.9)"> Subjects </router-link> </span> 
              {{-- <span class="site-menu-arrow"></span> --}}
          </a>
        </li>
        ...
        <li class="site-menu-item has-sub">
          <a href="javascript:void(0)">
              ...
              <span class="site-menu-title"> <router-link class="block" to="/questions" style="color: rgba(158,158,158,.9)"> Questions </router-link> </span> 
              {{-- <span class="site-menu-arrow"></span> --}}
          </a>
        </li>
        ...
        <li class="site-menu-item has-sub">
          ...
          <ul class="site-menu-sub">
            <li class="site-menu-item">
              <a class="" href="#">
                <span class="site-menu-title"> <router-link class="block" to="/exam-setup" style="color: rgba(158,158,158,.9)"> Setup Exams </router-link> </span>
              </a>
            </li>
            <li class="site-menu-item">
              <a class="" href="#">
                <span class="site-menu-title"> <router-link class="block" to="/access" style="color: rgba(158,158,158,.9)"> Exam Access </router-link> </span>
              </a>
            </li>
            <li class="site-menu-item">
              <a class="" href="#">
                <span class="site-menu-title"> <router-link class="block" to="/gradings" style="color: rgba(158,158,158,.9)"> Grading </router-link> </span>
              </a>
            </li>
          </ul>
        </li>
        ...
        <li class="site-menu-item has-sub">
          ...
          <ul class="site-menu-sub">
            <li class="site-menu-item">
              <a class="" href="{{route('check-result')}}">
                <span class="site-menu-title"> Check Result </span>
              </a>
            </li>
            <li class="site-menu-item">
              <a class="" href="{{route('promote-student')}}">
        ...
        <li class="site-menu-item has-sub">
          ...
          <ul class="site-menu-sub">
            <li class="site-menu-item">
              <a class="" href="{{route('check-result')}}">
                <span class="site-menu-title"> <router-link class="block" to="/fees" style="color: rgba(158,158,158,.9)"> Fees </router-link> </span>
              </a>
            </li>
            <li class="site-menu-item">
              <a class="" href="{{route('promote-student')}}">
                <span class="site-menu-title"> <router-link class="block" to="/" style="color: rgba(158,158,158,.9)"> Budget </router-link> </span>
              </a>
            </li>
            <li class="site-menu-item">
              <a class="" href="{{route('promote-student')}}">
                <span class="site-menu-title"> <router-link class="block" to="/" style="color: rgba(158,158,158,.9)"> Expense </router-link> </span>
              </a>
            </li>
          </ul>
        </li>
        ...
        <li class="site-menu-item has-sub">
          ...
          <ul class="site-menu-sub">
            <li class="site-menu-item">
              <a class="" href="#">
                <span class="site-menu-title"> <router-link class="block" to="/student-profile" style="color: rgba(158,158,158,.9)"> Student Profile </router-link> </span>
              </a>
            </li>
            <li class="site-menu-item">
              <a class="" href="#">
                <span class="site-menu-title"> <router-link class="block" to="/staff-profile" style="color: rgba(158,158,158,.9)"> Staff Profile </router-link> </span>
              </a>
            </li>
            <li class="site-menu-item">
              <a class="" href="#">
                <span class="site-menu-title"> <router-link class="block" to="/year-book" style="color: rgba(158,158,158,.9)"> Year Book </router-link> </span>
              </a>
            </li>
          </ul>
        </li>
